          ...
          <div>
            ...
            <div className="flex gap-2">
              <label className="flex-1 flex items-center justify-center gap-1.5 text-[11px] px-2 py-2 border border-slate-300 rounded bg-slate-50 hover:bg-slate-100 cursor-pointer text-slate-600 transition truncate font-medium">
                <Upload className="w-3 h-3 flex-shrink-0 text-[#8b1515]" />
                <span className="truncate">{selectedFile ? selectedFile.name : 'Upload'}</span>
                <input type="file" accept="image/*" onChange={handleFileChange} className="hidden" />
              </label>
              <label className="flex items-center justify-center gap-1 text-[11px] px-3 py-2 border border-slate-300 rounded bg-slate-800 hover:bg-slate-900 cursor-pointer text-white transition font-medium">
